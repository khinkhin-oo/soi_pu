    ...
    <div class="container">
                                 ...
                                 padding:5px;">
                                    ...
                                    <div style="margin-top: 15px">
                                        <div class="row-of-model">
                                            ...
                                            <div class="text-of-row-model" style="width: 40% !important; text-align: right; text-overflow: unset !important;">
                                                <img class="heart" style="width: 25px;height: 25px;" src="{{ asset('theme/images/heart.png') }}">
                                            </div>
                                        </div>
                                        <div class="row-of-model">
                                            &nbsp;
        ...
        <div class="row mt-5">
            <div class="col-md-12 text-center">
                {{-- {{ $arr_users->links('front.new.my-paginate') }} --}}
                {{ $arr_users->links() }}
            </div>
        </div>

            ...
            <div class="col-sm-12">
                ...
                <div class="add-form-section-main section-add-form">
                    <form action="{{url('/')}}/admin/location/store" id="frm_add" name="frm_add" method="post" enctype="multipart/form-data" onsubmit='addLoader()';>
                        ...
                        <div class="form-group">
                            <label class="control-label">Location Name EN <i class="red">*</i></label>
                        ...
                        <div class="form-group">
                            <label class="control-label">Location Name TH <i class="red">*</i></label>
                            <div class="input-group ">
                                <span class="input-group-addon"><i class="ti-layout-media-left-alt"></i></span>
                                <input type="text" id="location_name" name="location_name_th" class="form-control" placeholder="Enter Location" data-rule-required="true" maxlength="100">
                            </div>
                        </div>
                ...
                <div class="add-form-section-main edit-form-close-btn">
                    ...
                    <input type="hidden" name="location_id" id="location_id" value="">
                        <div class="form-head-section">
                            Edit Location <span class="add-form-close-btn"><i class="ti-close"></i></span>
                            <div class="clearfix"></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Location Name EN<i class="red">*</i></label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="ti-layout-media-left-alt"></i></span>
                                <input type="text" id="edit_location_name" name="edit_location_name" class="form-control" placeholder="Enter title" value="" data-rule-required="true" maxlength="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Location Name TH<i class="red">*</i></label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="ti-layout-media-left-alt"></i></span>
                                <input type="text" id="edit_location_name_th" name="edit_location_name_th" class="form-control" placeholder="Enter title" value="" data-rule-required="true" maxlength="100">
                            </div>
                        </div>
                        <div class="form-actions">
    ...
    <script>
        $(document).ready(function () {
            ...
            data: function(d) {
                ...
                d['column_filter[title_th]']      = $("input[name='title_th']").val()
        ...
        columns: [
                ...
                {data : 'title_th',"orderable":true,"searchable":true,name:'title_th'},
                /*@if(session('subadmin_id')==NULL)
            ...
            $.ajax({
                ...
                success:function(resp){
                    ...
                    if(resp.status=='success'){
                        $('#edit_location_name').val(resp.data.location_name);
                        $('#edit_location_name_th').val(resp.data.location_name_th);
                        $('#location_id').val(btoa(resp.data.id));
                        $("body").addClass("edit-form-open");
                        return true;

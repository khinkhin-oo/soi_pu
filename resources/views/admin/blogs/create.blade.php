        ...
        <div class="col-sm-12">
            <div class="white-box p-l-20 p-r-20">
               @include('admin.layout._operation_status')
                <div class="row">
                    <div class="col-md-12">
                         <form action="{{url('/')}}/admin/blogs/store" id="frm_admin" name="frm_admin"  class="form-horizontal cmxform"   method="post" enctype="multipart/form-data">
                           {{csrf_field()}}
                            <div class="form-body">
                                <div class="row">
                                   <div class="col-md-8">
                                        <div class=" form-group">
                                             <label class="control-label col-sm-4 col-md-4 col-lg-3" >Blog Image</label>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="control-label col-sm-4 col-md-4 col-lg-3" >Blog title <i class="red" >*</i></label>
                                            <div class="col-sm-8 col-md-8 col-lg-9">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="ti-marker-alt"></i></span>
                                                <input type="text" id="title" name="title" class="form-control" placeholder="Enter Blog title" data-rule-required="true" value="<?php echo isset($arr_admin_details['title'])? $arr_admin_details['title']: '' ?>" maxlength="100">
                                            </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label class="control-label col-sm-4 col-md-4 col-lg-3" >Blog slug <i class="red" >*</i></label>
                                            <div class="col-sm-8 col-md-8 col-lg-9">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="ti-shortcode"></i></span>
                                                    <input type="text" id="slug" name="slug" class="form-control" placeholder="Enter Slug" data-rule-required="true" readonly="true" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-md-8 col-lg-9">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="ti-marker-alt"></i></span>
                                                    <input type="text" id="meta_title" name="meta_title" class="form-control" placeholder="Enter Meta title" data-rule-required="true" value="<?php echo isset($arr_admin_details['meta_title'])? $arr_admin_details['meta_title']: '' ?>" maxlength="100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-md-8 col-lg-9">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="meta_keyword" name="meta_keyword" class="form-control" placeholder="Enter Meta Keyword" data-rule-required="true" value="<?php echo isset($arr_admin_details['meta_keyword'])? $arr_admin_details['meta_keyword']: '' ?>" maxlength="100" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-md-8 col-lg-9">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="meta_description" name="meta_description" class="form-control" placeholder="Enter Meta description" data-rule-required="true" value="<?php echo isset($arr_admin_details['meta_description'])? $arr_admin_details['meta_description']: '' ?>" maxlength="255" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group ">
                                             ...
                                             <div class="col-sm-8 col-md-8 col-lg-9">
                                                <div class="input-group">
                                                    <span class="input-group-addon"><i class="ti-receipt"></i></span>
                                                    <input type="text" id="short_description" name="short_description" class="form-control" placeholder="Enter Short description" data-rule-required="true" value="<?php echo isset($arr_admin_details['short_description'])? $arr_admin_details['short_description']: '' ?>" maxlength="100">
                                                 </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-md-8 col-lg-9">
                                                <div class="form-actions">
                                                    <button type="submit" class="fcbtn btn btn-danger btn-1g">  Create</button>

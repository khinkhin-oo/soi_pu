...
@section('main_content')
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="add-form-section-main section-add-form">
                    <form action="{{url('/')}}/admin/services/store" id="frm_add" name="frm_add" method="post" enctype="multipart/form-data" onsubmit='addLoader()';>
                        {{csrf_field()}}
                        <div class="form-head-section">
                            Add Service <span class="add-form-close-btn"><i class="ti-close"></i></span>
                            <div class="clearfix"></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Service Name EN<i class="red">*</i></label>
                            <div class="input-group ">
                                <span class="input-group-addon"><i class="ti-layout-media-left-alt"></i></span>
                                <input type="text" id="service_name" name="service_name" class="form-control" placeholder="Enter Service" data-rule-required="true" maxlength="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Service Name TH<i class="red">*</i></label>
                            <div class="input-group ">
                                <span class="input-group-addon"><i class="ti-layout-media-left-alt"></i></span>
                                <input type="text" id="service_name_th" name="service_name_th" class="form-control" placeholder="Enter Service" data-rule-required="true" maxlength="100">
                            </div>
                        </div>
                ...
                <div class="add-form-section-main edit-form-close-btn">
                    ...
                    {{csrf_field()}}
                    <input type="hidden" name="enc_id" id="service_id" value="">
                        <div class="form-head-section">
                            Edit Service <span class="add-form-close-btn"><i class="ti-close"></i></span>
                            <div class="clearfix"></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Service Name EN<i class="red">*</i></label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="ti-layout-media-left-alt"></i></span>
                                <input type="text" id="service" name="service_name" class="form-control" placeholder="Enter Service Name" value="" data-rule-required="true" maxlength="100">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Service Name TH<i class="red">*</i></label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="ti-layout-media-left-alt"></i></span>
                                <input type="text" id="service_th" name="service_name_th" class="form-control" placeholder="Enter Service Name" value="" data-rule-required="true" maxlength="100">
                            </div>
                        </div>
                        <div class="form-actions">
    ...
    <script>
        $(document).ready(function () {
            ...
            data: function(d) {
                d['column_filter[service_name]']      = $("input[name='service_name']").val()
                d['column_filter[service_name_th]']      = $("input[name='service_name_th']").val()
        ...
        columns: [
                ...
                {data : 'service_name',"orderable":true,"searchable":true,name:'service_name'},
                {data : 'service_name_th',"orderable":true,"searchable":true,name:'service_name_th'},
                /*@if(session('subadmin_id')==NULL)
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(resp.status=='success'){
                        $('#service').val(resp.data.service_name);
                        $('#service_th').val(resp.data.service_name_th);
                        $('#service_id').val(btoa(resp.data.id));
                        $("body").addClass("edit-form-open");
                        return true;

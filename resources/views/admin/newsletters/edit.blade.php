			...
			<div class="col-md-12">
				...
				<section class="panel">
					...
					<div class="panel-body">
						...
						<form action="{{$module_url}}/update/{{ base64_encode($arr_news_letter['id']) }}" id="frm_blogs_page" name="frm_blogs_page" class="form-horizontal cmxform" method="post" enctype="multipart/form-data">
							{{csrf_field()}}
							...
							<div class="form-group">
								<div class="col-sm-8 text-right">
									...
									<button class="fcbtn btn btn-danger btn-1g" type="submit"  id="btn_add_front_page">Update</button>
								</div>
							</div>
						</form>
					</div>

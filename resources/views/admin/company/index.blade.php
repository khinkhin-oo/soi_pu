...
@section('main_content')
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="add-form-section-main section-add-form">
                    <form action="{{url('/')}}/admin/company/store" id="frm_add" name="frm_add" method="post" enctype="multipart/form-data" onsubmit='addLoader()';>
                        {{csrf_field()}}
                        <div class="form-head-section">
                            Add Company <span class="add-form-close-btn"><i class="ti-close"></i></span>
                            <div class="clearfix"></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Company Name <i class="red">*</i></label>
                            <div class="input-group ">
                                <span class="input-group-addon"><i class="ti-layout-media-left-alt"></i></span>
                                <input type="text" id="company_name" name="company_name" class="form-control" placeholder="Enter Company" data-rule-required="true" maxlength="25">                                
                            </div>
                        </div>
                ...
                <div class="add-form-section-main edit-form-close-btn">
                    ...
                    {{csrf_field()}}
                    <input type="hidden" name="enc_id" id="company_id" value="">
                        <div class="form-head-section">
                            Edit Company <span class="add-form-close-btn"><i class="ti-close"></i></span>
                            <div class="clearfix"></div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Company Name<i class="red">*</i></label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="ti-layout-media-left-alt"></i></span>
                                <input type="text" id="company" name="company_name" class="form-control" placeholder="Enter company Name" value="" data-rule-required="true" maxlength="25">                                 
                            </div>
                        </div>
                        <div class="form-actions">
    ...
    <script>
        $(document).ready(function () {
            ...
            data: function(d) {
                d['column_filter[company_name]']      = $("input[name='company_name']").val()
            ...
            $.ajax({
                ...
                success:function(resp){
                    if(resp.status=='success'){
                        $('#company').val(resp.data.company_name);
                        $('#company_id').val(btoa(resp.data.id));
                        $("body").addClass("edit-form-open");
                        return true;

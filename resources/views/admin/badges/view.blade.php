                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        <tbody>                                 
                                            <tr>
                                                ...
                                                <td style="width: 25%;">{{isset($arr_data['last_name']) ? ucfirst($arr_data['last_name']) :'NA'}} </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 15%;">Email</th>
                                                <td style="width: 25%;">{{isset($arr_data['email']) ? ucfirst($arr_data['email']) :'NA'}} </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%;">@if($arr_data['line']=='yes'){{'Yes'}} @else {{'No'}}                        @endif  
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%;">{{isset($arr_data['country']) ? ucfirst($arr_data['country']) :'NA'}} 
                                                </td>
                                            </tr>
                                            <tr>
                                                <th style="width: 15%;">Address</th>
                                                <td style="width: 25%;">{{isset($arr_data['address']) ? ucfirst($arr_data['address']) :'NA'}} </td>        
                                                <th style="width: 15%;">Category</th>
                                                <td style="width: 25%;">{{isset($arr_data['get_category'][0]['category_name']) ? ucfirst($arr_data['get_category'][0]['category_name']) :'NA'}} </td>
                                            </tr>                                            
                                            <tr>

   ...
   <div class="row">
      <div class="col-sm-12">
         <div class="white-box p-l-20 p-r-20">
            ...
            <div class="row">
               <div class="col-md-12">
                  <form action="{{url('/')}}/admin/badges/store" method="post" enctype="multipart/form-data" onsubmit='addLoader()';>
                     {{csrf_field()}}
                    <div class="form-body">
                          ...
                          <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control" placeholder="Enter your Title" required="" value="{{old('question')}}" data-rule-required="true" maxlength="20">
                              </div>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                               ...
                               <div class="input-group">
                                 <span class="input-group-addon"><i class="ti-exchange-vertical"></i></span>
                                 <input type="number" id="order_by" name="order_by" class="form-control" placeholder="Order By" required="" value="0" data-rule-required="true" maxlength="20">
                               </div>
                             </div>
                           </div>
                            <div class="col-md-6">
                             <div class="form-group">
                                <label class="control-label">Points Start</label>
                                <div class="input-group">
                                  <span class="input-group-addon"><i class="ti-flag"></i></span>
                                  <input type="number" id="points_start" name="points_start" class="form-control" placeholder="Points Start" required="" value="0" data-rule-required="true" maxlength="20">
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-md-6">
                             <div class="form-group">
                                <label class="control-label">Points Stop</label>
                                <div class="input-group">
                                  <span class="input-group-addon"><i class="ti-flag-alt"></i></span>
                                  <input type="number" id="points_stop" name="points_stop" class="form-control" placeholder="Points Stop" required="" value="0" data-rule-required="true" maxlength="20">
                                </div>
                              </div>
                            </div>

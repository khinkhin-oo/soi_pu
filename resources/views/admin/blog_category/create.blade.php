                    ...
                    <div class="col-sm-12">
                        <div class="white-box p-l-20 p-r-20">
                           @include('admin.layout._operation_status')
                            <div class="row">
                                <div class="col-md-12">
                                     <form action="{{url('/')}}/admin/blog_category/store" id="frm_admin" name="frm_admin"  class="form-horizontal cmxform"   method="post" enctype="multipart/form-data">
                                           {{csrf_field()}}
                                        <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8 col-md-8 col-lg-9">
                                                            <div class="form-actions">
                                                                <button type="submit" id="submit" class="fcbtn btn btn-danger btn-1g"> <i class="fa fa-check"></i> Create</button>

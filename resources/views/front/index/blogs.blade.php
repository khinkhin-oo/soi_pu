<!DOCTYPE html>
<html lang="en">
@section('title',trans('index.blogtitle'))
@section('metadesc',trans('list').' '.$blogs->firstItem().'-'.$blogs->lastItem().' ( '.trans('index.from').' '.$blogs->total().') '.trans('index.total'))
...
<body>
        ...
        <div style="background-color: #fff;" class="middle-section-gray ads-page-middle">
            <div class="container">
                <div>               
                    <div class="login"><h1>{{trans('index.blogtitle')}}</h1>
                        <div class="login-line"></div>
                    </div>                                                               
                </div>

                @foreach($blogs as $blog)
                    <div style="background: #fff;box-shadow: 0px 0px 40px 0px rgba(0,0,0,0.05);border-radius: 10px;overflow: hidden;margin-top:30px;">
                        <article class="row mb-50">
                                        ...
                                        <div class="col-md-8" style="padding-top:20px;">
                                            <div class="post-content">
                                                ...
                                                <p class="font-medium">{{$blog->short_description}}</p>
                                                <a class="readmore-btn font-small text-uppercase font-weight-ultra" href="{{asset('blog/'.$blog->slug)}}">{{ trans('index.readmore') }}<i style=" margin-left: 5px !important" class="fas fa-arrow-right ml-5 transition-02s"></i></a>
                                            </div>
                                        </div>
                                    </article>
                    </div>

...
<head>
    ...
    <noscript>
        <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PK35FP4"
...
<nav class="navbar navbar-expand-lg navbar-dark bg-black" style="
    position: fixed;
    top: 0;
    width: 100%;
    z-index: 999999999;
">
    ...
    <a class="navbar-brand d-lg-none" href="{{asset('/')}}">
        ...
        <div class="login">
            <div class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                 aria-haspopup="true" aria-expanded="false" style="color:white;-webkit-appearance: none;
    -moz-appearance: none;
    appearance: none;">
                @if(\App::isLocale('th'))
                TH
    ...
    appearance: none;">
        ...
        <button id="button-toggler"class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02"
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                ...
                @if(\App::isLocale('th'))
                <li class="nav-item">
                    <a class="nav-link" href="{{asset('/blogs')}}">
                ...
                @else
                <li class="nav-item">
                    <a class="nav-link" href="{{asset('/en/blogs')}}">
                        <i class="fa fa-book" aria-hidden="true"></i>
                        {{ trans('header.blogs') }}
                    </a>
                </li>
            ...
            <ul class="navbar-nav mr-auto mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{asset('/forum')}}">

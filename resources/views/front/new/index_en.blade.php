...
<div style="margin-top: 60px">
                            ...
                            <div class="col-md-12 col-12 mt-3 pl-1 pr-1">
                                <div class="text-center text-light">
                                    ...
                                    <div class="banner_search_box">
                                        <input type="search" name="bn_search" id="bn_search" class=""
    ...
    <div class="container">
                        ...
                        @foreach ($arr_banner as $banner)
                            <div class="col-md-2 col-2 mt-2 pl-1 pr-1">
                                @if (!empty($banner['url']))
                                    ...
                                    @else
                                        <a style="color: black"
                                            href="{{ asset('view_by_company/' . base64_encode($banner['company'])) }}">
                                @endif
                                <div class="advertise_box">
                                    <div class="adv_img_box">
                                        @if (isset($banner['banner_image']) &&
                                            ...
                                            <img class="adv_img"
                                                src="{{ $banner_public_img_path }}{{ $banner['banner_image'] }}" />
                                        @else
        ...
        <section class="models mt-5">
            ...
            <div class="container-fluid">
                ...
                <div id="grid-3" class="row grid">

                    @if (isset($arr_users))
                        @foreach ($arr_users as $models)
                            <a style="color: inherit;
                                    text-decoration: inherit;"
                                href="{{ url('/list_details') }}/{{ base64_encode($models['id']) }}">
                                <div class="col-md-4 col-lg-3 col-xl-3 col-sm-6 col-6 mt-6"
                                    style="
                                 padding:5px;">

                                    <div class="model-container rg_item text-center">
                                        ...
                                        @if (isset($models['get_images'][0]['profile_image']) &&
                                            ...
                                            @elseif(isset($models['get_images'][0]['profile_image']) &&
                                                ...
                                                @else
                                                    <div class="model-container-img" {{-- style="background-image:url({{ asset('/assets/front/images/no-img-found.jpg') }})"> --}}
                                                        style="background-image:url('{{ $base_img_public_path }}{{ $models['get_images'][0]['profile_image'] }}')">
                                        @endif
                                    </div>
                                    ...
                                    <div style="margin-top: 15px">
                                        <div class="row-of-model">
                                            ...
                                            <div class="text-of-row-model"
                                                style="width: 50% !important; color: #1396ec; font-family: 'Kanit-Bold', Arial !important;">
                                                @if (\App::isLocale('th'))
                                            ...
                                            <div class="text-of-row-model"
                                                style="width: 40% !important; text-align: right; text-overflow: unset !important;">
                                                <img class="heart" style="width: 25px;height: 25px;"
                                        ...
                                        <div class="row-of-model">
                                            ...
                                            <div class="text-of-row-model"
                                                style="color: rgb(49, 48, 48); font-family: 'Kanit-Bold', Arial !important;">

                                                <img style="width: 25px;height: 25px;"
                                                    src="{{ asset('theme/images/location.png') }}">
                                        ...
                                        <div class="row-of-model">
                                            ...
                                            <div class="text-of-row-model"
                                                style="width: 50% !important; color: #920092; font-family: 'Kanit-Bold', Arial !important;">
                                                @if ($models['gender'] != null && !empty($models['gender']))
                                                    @if (\App::isLocale('th'))
                                                        <?php
                                                        switch ($models['gender']) {
                                                            case 'Male':
                                                                $models['gender'] = 'ผู้ชาย';
                                                                break;
                                                            case 'Female':
                                                                $models['gender'] = 'ผู้หญิง';
                                                                break;
                                                            case 'LadyBoy':
                                                                $models['gender'] = 'สาวสอง';
                                                                break;
                                                        }
                                                        ?>
                                                    @endif
                                        ...
                                        <div class="row-of-model">
                                            <div class="text-of-row-model"
                                                style="width: 50% !important; color: #000; font-family: 'Kanit-Bold', Arial !important;">
                                                &nbsp;&nbsp;{{ trans('list_details.age') }}
                                                {{ $models['age'] }}
                                            </div>
                                            <div class="text-of-row-model"
                                                style="color: rgb(0,0,0) ;font-size:16px;font-weight: bolder;text-align: right;width: 40% !important; text-overflow: unset !important;">
                                                <?php
    ...
    <section id="sex_article">
        <div class="container-fluid">
            <div class="row">

                <div class="col-md-12 text-center my-2">
                    <h1 class="sex_article_title">Sex Article</h1>
                </div>
                    ...
                    <div class="article_box_container">
                        ...
                        <div class="article_box">
                            ...
                            <div class="article_text">
                                <img src="" alt="">
                                <span>Admin</span>
                                <p>11 ways to help yourself to a better sex life</p>
                                <p class="article_text_p2">Lorem Ipsum is simply dummy text of the printing and typesetting
                                    industry. Lorem Ipsum
                                    has been the industry's standard dummy text ever since the 1500s,</p>
                            </div>

                            <div class="artile_image">
                                <img src="../../../theme/images/banner3.png" alt="">
                            </div>
                ...
                <div class="col-md-12 text-center">
                    <a href="#" class="btn seemore_btn">See More</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
        setInterval(async function() {
            ...
            console.log(data.json(),'Refreshing')
        }, 20000);
    </script>

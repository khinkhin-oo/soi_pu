...
<!-- Mirrored from wrappixel.com/ampleadmin/ampleadmin-html/ampleadmin-minimal/400.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Apr 2017 10:36:51 GMT -->
<head>
<meta charset="utf-8">
...
<link rel="icon" type="{{ url('/') }}/assets/admin_assets/images/png" sizes="16x16" href="{{ url('/') }}/assets/admin_assets/images/favicon.ico">
...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      ...
      <a href="{{ url('/') }}/admin/dashboard" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>

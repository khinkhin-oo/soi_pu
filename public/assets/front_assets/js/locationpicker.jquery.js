    ...
    var GmUtility = {
        ...
        updateLocationName: function(gmapContext, callback) {
            gmapContext.geodecoder.geocode({
                ...
                {
 var address = GmUtility.addressByFormat(results, gmapContext.settings.addressFormat);
                    gmapContext.locationName = 'Cannot determine address at this location.';
                }
                if (callback) {
                    callback.call(this, gmapContext);
                }
        ...
        address_component_from_google_geocode: function(address_components) {
            ...
            if(result.addressLine1=='Unnamed Road')
            {
             result.addressLine1='';   
            }

            if(result.streetName=='Unnamed Road')
            {
             result.streetName='';   
            }
            result.addressLine2 = "";
    ...
    function updateInputValues(inputBinding, gmapContext,status=1) {
        ...
        if (inputBinding.locationNameInput&&status) {
            var finalLocation = gmapContext.locationName;
            var res = finalLocation.replace("Unnamed Road, ", "");
            inputBinding.locationNameInput.val(res).change();
        }
    }
            ...
            if (inputBinding.locationNameInput && gmapContext.settings.enableAutocomplete) {
                ...
                google.maps.event.addListener(gmapContext.autocomplete, "place_changed", function() {
                    ...
                    GmUtility.setPosition(gmapContext, place.geometry.location, function(context) {
                        updateInputValues(inputBinding, context,0);
                        context.settings.onchanged.apply(gmapContext.domContainer, [ GmUtility.locationFromLatLng(context.location), context.radius, false ]);
                    });
                });
